...
**Centro de Ayuda:**
- Accesible desde cualquier pantalla (ícono "?" en la barra superior)
...
**Correo Electrónico:**
- **Email:** soporte@sistemamultas.gov.co
- **Tiempo de respuesta:** 24-48 horas hábiles

**Teléfono:**
- **Línea:** +57 (1) XXX-XXXX
- **Horario:** Lunes a Viernes, 8:00 AM - 5:00 PM
- **WhatsApp:** +57 XXX XXX XXXX (solo consultas)
...
### 11.2 Cómo Reportar un Problema
...
- ¿Aparece algún mensaje de error? (envíe captura)
- ¿Cuándo ocurrió?
...
- Tome captura de pantalla del error
- Anote los pasos que realizó antes del problema
- Verifique si el problema persiste al actualizar

**Paso 2: Enviar Reporte**

**Opción A: Desde el Sistema**
1. Haga clic en el ícono "?" (Ayuda)
...
**Opción B: Por Correo**
1. Envíe email a soporte@sistemamultas.gov.co
2. Asunto: "Reporte de problema - [Breve descripción]"
3. Incluya toda la información solicitada
4. Adjunte capturas

**Paso 3: Seguimiento**
- Recibirá un número de ticket
- Use ese número para consultar el estado
- Recibirá actualizaciones por correo
- Tiempo estimado de resolución: 1-5 días hábiles

---

### 11.3 Niveles de Soporte
...
#### Nivel 2: Soporte Técnico Básico
- Problemas de acceso
- Recuperación de contraseña
- Consultas sobre uso básico
...
#### Nivel 4: Soporte Administrativo
- Cambios en permisos
...
- Manual de Administrador (versión extendida)
- Guías rápidas por módulo
- Tutoriales paso a paso

**Formato:**
- PDF descargable
- HTML (consulta en línea)
- Videos instructivos

#### Videos Tutoriales

Acceda a nuestra videoteca con:
- Registro e inicio de sesión (5 min)
- Consulta de multas (3 min)
- Generación de acuerdos de pago (8 min)
- Pago de cuotas (4 min)
- Administración de usuarios (10 min)

**Acceso:** Menú Ayuda → Videos Tutoriales
...
- Talleres para administradores
- Solicitar con 15 días de anticipación

**Para registrarse:**
- Email: capacitacion@sistemamultas.gov.co
- Tel: +57 (1) XXX-XXXX ext. 123

---

### 11.5 Actualizaciones del Sistema

#### Notificación de Actualizaciones

**Canales de Comunicación:**
- Notificación dentro del sistema
- Correo electrónico a todos los usuarios
- Publicación en página de inicio
...
- Generalmente: Domingos 12:00 AM - 6:00 AM
- Notificación con 7 días de anticipación
- Durante mantenimiento el sistema no estará disponible

**Mantenimiento de Emergencia:**
- Se notifica con mínimo 2 horas de anticipación
- Solo en casos críticos
- Se publica en redes sociales y página principal

#### Versiones y Cambios

**Control de Versiones:**
- Versión actual visible en pie de página
- Notas de versión disponibles en "Acerca de"
- Registro de cambios públicos

**Para ver cambios:**
1. Haga clic en el pie de página "v1.0.0"
2. Se abrirá ventana con notas de versión
3. Revise "¿Qué hay de nuevo?"
...
**PSE:** Pagos Seguros en Línea, sistema de pago electrónico.
...
✓ Revise sus notificaciones regularmente
✓ Configure alertas de vencimiento
✓ Guarde comprobantes de pago
✓ Use acuerdos de pago si no puede pagar de inmediato
