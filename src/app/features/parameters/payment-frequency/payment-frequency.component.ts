...
import { PaymentFrequencyService } from '../../../core/services/payment-frequency.service';
...
export class PaymentFrequencyComponent implements OnInit {
  ...
  constructor() {
    ...
    this.paymentFrequencyForm = this.fb.group({
      ...
      dueDayOfMonth: ['', [Validators.required, Validators.min(1), Validators.max(31)]]
    });
  ...
  abrirFormularioActualizar(paymentFrequency: PaymentFrequency): void {
    ...
    this.updateForm.patchValue({
      ...
      dueDayOfMonth: paymentFrequency.dueDayOfMonth
    });
